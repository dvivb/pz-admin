...
class AnnexeStructureController extends Controller
{
    use ModelForm;
        ...
        return Admin::content(function (Content $content) {
            ...
            $content->body(Dictionary::tree(function ($tree) {
                $tree->query(function ($model) {
                    return $model->where('subject', 'annexe_structure');
                });
            }));
        });
    }
    ...
    protected function form()
    {
        return Admin::form(Dictionary::class, function (Form $form) {
            ...
            $form->display('id', 'ID');
            $form->hidden('subject')->value('annexe_structure'); // 主题
            ...
            $form
                ...
                ->ajax('/admin/api/dictionaries/annexe_structure');
